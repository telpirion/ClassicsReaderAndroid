...
class LatinReaderManifest : Manifest() {
    ...
    override fun getCollection() = arrayListOf(
        WorkInfo.Builder("CaesarBG")
            ...
            .TOCEntry(TOCEntry("", 0, 0))
            .TOCEntry(TOCEntry("", 1, 0))
            .TOCEntry(TOCEntry("", 2, 0))
            .TOCEntry(TOCEntry("", 3, 0))
            .TOCEntry(TOCEntry("", 4, 0))
            .TOCEntry(TOCEntry("", 5, 0))
            .TOCEntry(TOCEntry("", 6, 0))
            .TOCEntry(TOCEntry("", 7, 0))
